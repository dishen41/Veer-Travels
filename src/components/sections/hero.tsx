...
export default function Hero() {
  return (
    <section className="relative w-full h-[60vh] md:h-[80vh] lg:h-screen p-0">
      <Carousel
                ...
                <div className="relative w-full h-[60vh] md:h-[80vh] lg:h-screen">
                  {imageData && (
                    <Image
                      ...
                      priority={heroImages.indexOf(hero) === 0}
                    />
                  )}
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end text-center text-white p-8 md:p-12">
                    <div className="max-w-4xl">
                      <p className="text-lg md:text-xl font-semibold text-accent mb-2">{hero.subtitle}</p>
